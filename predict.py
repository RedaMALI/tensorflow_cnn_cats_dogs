...
# Open train_ids file
with open(results_path+'to_predict.txt') as train_ids_output_handler:
  train_ids = train_ids_output_handler.readlines()
  train_ids = [x.strip() for x in train_ids]

for train_id in train_ids:

  if len(train_id) == 0: continue
  ...
  # Pause few seconde before next predict
  time.sleep(5)
